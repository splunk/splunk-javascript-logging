...
describe("SplunkLogger", function() {
    describe("constructor", function () {
        ...
        it("should correctly parse 1 < port < 1000", function() {
            ...
            assert.strictEqual("splunk-javascript-logging/0.10.2", logger.config.name);
    ...
    describe("_initializeConfig", function() {
        ...
        it("should correctly parse 1 < port < 1000", function() {
            ...
            assert.strictEqual("splunk-javascript-logging/0.10.2", loggerConfig.name);
    ...
    describe("constructor + _initializeConfig", function() {
        it("token in constructor, then init with empty config", function() {
            ...
            var expected = {
                token: config.token,
                name: "splunk-javascript-logging/0.10.2",
                host: "localhost",
